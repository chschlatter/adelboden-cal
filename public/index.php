            ...
            <div class="modal-body">
              <div class="row mb-3">
                ...
                <div class="col-sm-5">
                  ...
                  aria-describedby="input-start-date-msg">
                  <div id="input-start-date-msg" class="invalid-feedback"></div>
                </div>
            
                <label for="end" class="col-sm-1 col-form-label">Bis:</label>
                <div class="col-sm-5">
                  <input type="date" class="form-control" name="end" id="input-end-date" 
                  aria-describedby="input-end-date-msg">
                  <div id="input-end-date-msg" class="invalid-feedback"></div>
                </div>
              </div>
            </div>
